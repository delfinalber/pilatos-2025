<?php require_once 'generar_tarjetas.php'; ?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Hombre - PILATOS</title>
  ...
  <div class="row">
    ...
    <div class="row">
       ...
       <div style="text-align: center;">
         ...
         <nav>
          <div class="nav-wrapper" style="background-color: darkgray;">
    ...
    <!--Inicio Productos Dinámicos -->
    <div class="row">
        <?php echo generarTarjetasProductos(); ?>
    </div>
    <!--Fin Productos Dinámicos -->
    <br>
